...
NWW_PATH = "C:\\Users\\kyawl\\Desktop\\GitHub\\CSAI_Voice_Assistant\\Data\\Wake Word\\Not Wake Word\\"
JSON_PATH = "C:\\Users\\kyawl\\Desktop\\GitHub\\CSAI_Voice_Assistant\\Data\\Wake Word\\"
...
DROPOUT = 0.3
ACTIVATIONS = 4
EPOCHS = 30 # up to tester
BATCH_SIZE = 32 # power of 2 for optimal
...
def build_model():
    ...
    model.add(layers.GRU(GRU_UNIT, activation = 'linear', input_shape = (46, 13), dropout = DROPOUT, name = 'net'))
    model.add(layers.Dense(1, activation = 'sigmoid'))
    model.compile(optimizer = 'adam', lost = 'binary_crossentropy', metrics = ['accuracy'])
    return model
...
if read == "y":
    ...
    for i in range(len(nww_train_data_keys)):
        train_data.append(nww_train_data[nww_test_data_keys[i]])
